...
class AddEngineForm(forms.ModelForm):
    ...
    port_scan = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={}))
...
class UpdateEngineForm(forms.ModelForm):
    ...
    screenshot = forms.BooleanField(required=False, widget=forms.CheckboxInput())
    ...
    osint = forms.BooleanField(required=False, widget=forms.CheckboxInput())
    yaml_configuration = forms.CharField(
        widget=AceWidget(
            mode="yaml",
            theme="monokai",
...
class NotificationForm(forms.ModelForm):
    ...
    slack_channel_id = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "id": "slack_channel_id",
                "placeholder": "slack cahnnel ID (yyyyyyyyyyy)",
            }
        ),
    )
    ...
    def set_value(self, key):
        ...
        self.initial["slack_token"] = key.slack_token
        self.initial["slack_channel_id"] = key.slack_channel_id
    ...
    def set_initial(self):
        ...
        self.fields["slack_token"].widget.attrs["readonly"] = True
        self.fields["slack_channel_id"].widget.attrs["readonly"] = True
        self.fields["discord_hook_url"].widget.attrs["readonly"] = True
        self.fields["telegram_bot_token"].widget.attrs["readonly"] = True
        self.fields["telegram_bot_chat_id"].widget.attrs["readonly"] = True
